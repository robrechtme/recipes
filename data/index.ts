...
export const images = {
  "aardappel-ovenschotel-met-linzen-en-kikkererwten":
    aardappelOvenschotelMetLinzenEnKikkererwtenImage,
  ...
  "gnocchi-met-bloemkool-en-paprikasaus-uit-de-oven":
    gnocchiMetBloemkoolEnPaprikasausUitDeOvenImage,
  ...
  "risotto-van-orzo-met-paddenstoelen-en-kruidenkaas":
    risottoVanOrzoMetPaddenstoelenEnKruidenkaasImage,
